// parser.cpp
// Ýòîò ôàéë ñîäåðæèò ðåàëèçàöèþ êëàññà TParser,
// îñóùåñòâëÿþùåãî ðàçáîð çàäàííîãî ìàòåìàòè÷åñêîãî âûðàæåíèÿ.
...
bool TParser::GetToken(void)
{
   *curToken = '\0';
   ...
   else if(IsLetter())
   {
      ...
      else if(!strcmp(curToken, "tan"))     { typToken = PARSER_TG; return true; }
      ...
      else if(!strcmp(curToken, "√"))   { typToken = PARSER_SQRT; return true; }
      else SendError(0);
   }
